...
exports.run = function(isDebug){
    ...
    //app.use(express.static(path.join(process.cwd(), 'packageApp')));
    //app.use(express.static(path.join(process.cwd(), 'onlineHtml')));
    ...
    console.log(ENV.flag + 'demo页面地址：http://127.0.0.1:3000/demo/xxx.html');
