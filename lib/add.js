 ...
 * @returns {Promise}
 */
var getSPM_A = function(){
    return new Promise(function(resolve){
        prompt(color.cyan(FLAG + 'The spm_a of the page?'), function (val) {
            param.spm_a = val.trim();
            resolve();
        });
    });
};
 ...
 * @returns {Promise}
 */
var getSPM_B = function(){
    return new Promise(function(resolve){
        prompt(color.cyan(FLAG + 'The spm_b of the page?'), function (val) {
            param.spm_b = val.trim();
            resolve();
        });
    });
};
